...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # button 1
        std_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\web.png")
        ...
        std_b1_1 = Button(bg_img,command=self.website,text="Website",cursor="hand2",font=("tahoma",15,"bold"),bg="#FFFF00",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # button 2
        det_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\yt.png")
        ...
        att_b1_1 = Button(bg_img,command=self.youtube,text="Youtube",cursor="hand2",font=("tahoma",15,"bold"),bg="#FF0000",fg="navyblue")
        att_b1_1.place(x=710,y=380,width=180,height=45)

         # Help  Support  button 4
        hlp_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\gmail.png")
        ...
        hlp_b1_1 = Button(bg_img,command=self.gmail,text="Gmail",cursor="hand2",font=("tahoma",15,"bold"),bg="#00FF00",fg="navyblue")
    ...
    def website(self):
        self.new = 1
        self.url = "https://linktr.ee/vikasbairagi08"
    ...
    def youtube(self):
        self.new = 1
        self.url = "https://www.youtube.com/channel/UC_XVVouQPoBqI_18Osft3Cw"
        webbrowser.open(self.url,new=self.new)
