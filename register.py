...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bgReg.jpg")
        ...
        # img1=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\reg1.png")
        ...
        get_str = Label(frame,text="REGISTRATION PORTAL !",font=("times new roman",30,"bold"),fg="#E41B17",bg="#F2F2F2")
        ...
        # Checkbutton
        checkbtn = Checkbutton(frame,variable=self.var_check,text="I Agree the Terms & Conditions",font=("times new roman",13,"bold"),fg="#800080",bg="#F2F2F2")
        checkbtn.place(x=100,y=480,width=270)


        # Creating Button Register
        loginbtn=Button(frame,command=self.reg,text="REGISTER",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#000000",bg="#00FF00",activeforeground="white",activebackground="#007ACC")
        loginbtn.place(x=103,y=510,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#FF0000",activeforeground="white",activebackground="#007ACC")
