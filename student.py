...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","BCA","MCA","B.Tech","M.Tech","BBA","MBA","B.com","M.com","BA","MA")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","Artificial Intelligence","Machine Learning","Full Stack Web Devlopment","Blockchain Devlopment","Cyber Security","Data Scientist")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2017","2018","2019","2020","2021","2022","2023","2024","2025")
        ...
        #Student id
        studentId_label = Label(class_Student_frame,text="Std-ID:",font=("verdana",12,"bold"),fg="Dark Green",bg="white")
        ...
        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,font=("verdana",12,"bold"),fg="white",bg="Dark red")
        ...
        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("verdana",12,"bold"),fg="black",bg="yellow")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,text="Update Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="crimson")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("verdana",12,"bold"),fg="white",bg="Orange")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                face_classifier = cv2.CascadeClassifier(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path=r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\data_img/stdudent."+str(id)+"."+str(img_id)+".jpg"
