...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\loginBg1.jpg")
        ...
        img1=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\log1.png")
...
# This part is image labels setting start 
        ...
        # backgorund image 
        bg1=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg3.jpg")
        bg1=bg1.resize((1530,710),Image.Resampling.LANCZOS)
        ...
        #title section
        title_lb1 = Label(bg_img,text="FACE RECOGNITION BASED ATTENDANCE MANAGEMENT SYSTEM",font=("verdana",30,"bold"),bg="black",fg="#00FF00")
        title_lb1.place(x=0,y=0,width=1530,height=45)

        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\std1.jpg")
        ...
        std_b1_1 = Button(bg_img,command=self.student_pannels,text="Student Pannel",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="#00008B")
        std_b1_1.place(x=250,y=280,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\det1.jpg")
        ...
        det_b1_1 = Button(bg_img,command=self.face_rec,text="Face Detector",cursor="hand2",font=("tahoma",15,"bold"),bg="#FF2400",fg="black")
        det_b1_1.place(x=480,y=280,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\hlp.jpg")
        ...
        hlp_b1_1 = Button(bg_img,command=self.helpSupport,text="Help Support",cursor="hand2",font=("tahoma",15,"bold"),bg="#00FF00",fg="navyblue")
        hlp_b1_1.place(x=940,y=280,width=180,height=45)

         # ChatBot  button 5
        bot_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\chatbot.png")
        bot_img_btn=bot_img_btn.resize((180,180),Image.Resampling.LANCZOS)
        self.bot_img1=ImageTk.PhotoImage(bot_img_btn)

        bot_b1 = Button(bg_img,command=self.chatbot,image=self.bot_img1,cursor="hand2",)
        bot_b1.place(x=1170,y=100,width=180,height=180)

        bot_b1_1 = Button(bg_img,command=self.chatbot,text="ChatBot",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        bot_b1_1.place(x=1170,y=280,width=180,height=45)

        # Top 5 buttons end.......
        # ---------------------------------------------------------------------------------------------------------------------------
        # Start below buttons.........
         # Train   button 6
        tra_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\tra1.jpg")
        ...
        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",15,"bold"),bg="#66FF00",fg="Black")
        tra_b1_1.place(x=250,y=510,width=180,height=45)

        # Photo   button 7
        pho_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\qr1.png")
        ...
        # Developers   button 8
        dev_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\dev.jpg")
        ...
        dev_b1_1 = Button(bg_img,command=self.developr,text="Developers",cursor="hand2",font=("tahoma",15,"bold"),bg="#FFFF00",fg="navyblue")
        dev_b1_1.place(x=710,y=510,width=180,height=45)


        # extra   button 9
        exi_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\qr1.png")
        ...
        exi_b1_1 = Button(bg_img,command=self.Close,text="Extras",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        exi_b1_1.place(x=940,y=510,width=180,height=45)

        # exit   button 10
        exi_img_btn=Image.open(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\exi.jpg")
        exi_img_btn=exi_img_btn.resize((180,180),Image.Resampling.LANCZOS)
        self.exi_img1=ImageTk.PhotoImage(exi_img_btn)

        exi_b1 = Button(bg_img,command=self.Close,image=self.exi_img1,cursor="hand2",)
        exi_b1.place(x=1170,y=330,width=180,height=180)

        exi_b1_1 = Button(bg_img,command=self.Close,text="Exit",cursor="hand2",font=("tahoma",15,"bold"),bg="#00008B",fg="yellow")
        exi_b1_1.place(x=1170,y=510,width=180,height=45)

# ==================Funtion for Open Images Folder==================
    def open_img(self):
        os.startfile(r"E:\PROJECTS\Face Recognition Attendance System\Python-FYP-Face-Recognition-Attendence-System-master\data_img")
...
# ==================Functions Buttons=====================
    ...
    def Close(self):
        self.Close=tkinter.messagebox.askyesno("Face Recognition","Are you sure want to exit?",parent=self.root)
        if self.Close >0:
            self.root.destroy()
        else:
                return
